...
kernel_path = "/home/wangruting/Paddle/paddle/phi/kernels/xpu"
online_kernel_path = "https://github.com/PaddlePaddle/Paddle/blob/develop/paddle/phi/kernels/xpu/"
...
for file_name in kernel_file_list:
    ...
    with open(file_name, 'r') as f:
        ...
        for i in range(0, len(lines)):
            line = lines[i]           
            if line.find("PD_REGISTER_KERNEL(") != -1:
                if line.endswith("(\n"):
                    op_line = lines[i + 1]
